...
class Window(QtWidgets.QWidget):
    def __init__(self):
        ...
        # WIDGETS
        self.widgets = dict()
        self.widgets['widget1'] = QtWidgets.QCheckBox("Option1", self)
        self.widgets['widget2'] = QtWidgets.QCheckBox("Option2", self)
        self.widgets['widget3'] = QtWidgets.QCheckBox("Option3", self)
        self.widgets['widget4'] = QtWidgets.QStatusBar(self)
        self.widgets['widget1'].toggle()
        self.widgets['widget1'].stateChanged.connect(self.callback)
